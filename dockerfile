...
-subj "/C=MA/ST=0/L=Khourigba/O=rs1/OU=rs1/CN=10.11.6.7/emailAddress=agoumihunter@gmail.com" \
-keyout /etc/gitlab/ssl/gitlab.key -out /etc/gitlab/ssl/gitlab.crt

RUN git clone https://github.com/M-Agoumi/dockerscript.git /gitlab-files
